...
public class WebSocketStressTest extends TestCase
{
	...
	/**
	 * TODO: I have commented out this test method since it is failing on my
	 * machine.
	 */
	...
	private void doNumClientTest(int numClients) throws IOException, TimeoutException
	{
		...
		clients.waitForDone(5000);
		servers.waitForDone(5000);
	}
	...
	class WSClients extends WSManager
	{
		...
		{
			WSInterface newSocket = WSFactory.getInstance().createWebSocketClient(ss.getURI(), readerFactory.getReader(), WSFactory.VERSION_HIXIE_76, null);
			synchronized (this) {
